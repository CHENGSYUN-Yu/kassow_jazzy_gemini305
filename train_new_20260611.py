"""
Train from official YOLO11m-seg pretrained weights (no fine-tune base).
...
BASE_MODEL  = "yolo11m-seg.pt"   # official pretrained, auto-downloaded if not cached
DATA_YAML   = "/home/bf-robotics/jazzy0605/surgical_instrument_seg.v1i.yolo26/data.yaml"
PROJECT     = "runs/seg_20260611"
RUN_NAME    = "yolo11m_new_20260611"
SAVE_DIR    = "kassow_RobotUse/models"
OUTPUT_NAME = "best_new_20260611.pt"
