"""
Train from official YOLO11m-seg pretrained weights on v2 dataset (color, Fit black edges).
Hyperparameters mirror best20260603.pt train_args; imgsz=640 (Roboflow images are 640x640).
"""
...
DATA_YAML   = "/home/bf-robotics/jazzy0605/surgical_instrument_seg.v2i.yolo26/data.yaml"
PROJECT     = "runs/seg_v2_20260611"
RUN_NAME    = "yolo11m_v2_20260611"
SAVE_DIR    = "kassow_RobotUse/models"
OUTPUT_NAME = "best_v2_20260611.pt"
...
best_src = os.path.join("runs/segment", PROJECT, RUN_NAME, "weights", "best.pt")
if not os.path.exists(best_src):
    best_src = os.path.join(PROJECT, RUN_NAME, "weights", "best.pt")
